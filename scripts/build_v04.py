...
t = t.replace("出生日期（民國或西元皆可）", "出生日期／年代（民國、西元、年號皆可）")
t = t.replace("例如：民國108年10月18日，或2019-10-18", "例如：民國108年10月18日、2019-10-18、1081018，或清光緒辛丑年")
t = t.replace("不用換算；匯出時能辨識的日期會自動統一成民國格式。", "不用換算；能辨識的現代日期會自動統一成民國格式。像「清光緒辛丑年」這類年號文字會原樣保留，不自行改寫。")
